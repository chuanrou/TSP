...
public class TSPGreedyExample {
	...
	public static class TSPProblem extends AbstractProblem {
		 ...
		 */
		private final TSPGreedyHeuristic heuristic;
		...
		public TSPProblem(TSPInstance instance) {
			...
			heuristic = new TSPGreedyHeuristic(instance);
		}
	...
	public static void solve(TSPInstance instance) {
		...
		Logger logger = LogToFile.setLoggerHanlder(Logger.getLogger("my.logger"), Level.FINEST, "TSP_"+algorithmname+"_Greedy_"+instance.getName()+"_");  
